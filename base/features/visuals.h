...
private:
	...
	// On-Screen
	void HitMarker(const Vector2D& vecScreenSize, float flServerTime, Color colLines, Color colDamage);
	...
	void Bomb(const Vector2D& vecScreen, Context_t& ctx, const Color& colFrame) const;
	/* draw frame with title, timer and defuse bars at planted bomb position */
	void PlantedBomb(CPlantedC4* pBomb, float flServerTime, const Vector2D& vecScreen, Context_t& ctx, const Color& colFrame, const Color& colDefuse, const Color& colFailDefuse, const Color& colBackground, const Color& colOutline) const;
	/* draw frame with name and timer bar at grenade position */
	void Grenade(CBaseEntity* pGrenade, EClassIndex nIndex, float flServerTime, const Vector2D& vecScreen, Context_t& ctx, const Color& colFrame, const Color& colBackground, const Color& colOutline) const;
