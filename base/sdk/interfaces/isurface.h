...
public:
	...
	void DrawSetColor(FGUI::COLOR colDraw)
	{
		MEM::CallVFunc<void>(this, 15, colDraw.m_ucRed, colDraw.m_ucGreen, colDraw.m_ucBlue, colDraw.m_ucAlpha);
	}
	...
	void DrawSetTextColor(FGUI::COLOR colDraw)
	{
		MEM::CallVFunc<void>(this, 25, colDraw.m_ucRed, colDraw.m_ucGreen, colDraw.m_ucBlue, colDraw.m_ucAlpha);
	}
