...
namespace FGUI
{
	...
	void CSlider::Geometry(FGUI::WIDGET_STATUS status)
	{
		...
		// slider outline
		FGUI::RENDER.Outline(arWidgetRegion.m_iLeft - 1, arWidgetRegion.m_iTop - 1, arWidgetRegion.m_iRight + 2, arWidgetRegion.m_iBottom + 2, { 50, 50, 50 });
		...
		// slider
		FGUI::RENDER.Rectangle(arWidgetRegion.m_iLeft, arWidgetRegion.m_iTop, flLocation, arWidgetRegion.m_iBottom, accentColor);
