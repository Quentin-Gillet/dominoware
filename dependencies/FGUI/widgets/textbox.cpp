...
namespace FGUI
{
	...
	void CTextBox::Geometry(FGUI::WIDGET_STATUS status)
	{
		...
		{
			FGUI::RENDER.Text(arWidgetRegion.m_iLeft + 2, arWidgetRegion.m_iTop + (arWidgetRegion.m_iBottom / 2) - (dmTitleTextSize.m_iHeight / 2), m_anyFont, { 255, 255, 255 }, m_strCustomText);
		}
		...
		{
			FGUI::RENDER.Text(arWidgetRegion.m_iLeft + 2, arWidgetRegion.m_iTop + (arWidgetRegion.m_iBottom / 2) - (dmTitleTextSize.m_iHeight / 2), m_anyFont, { 255, 255, 255 }, std::string(m_strCustomText.length(), '*'));
		}
		...
		if (m_bIsGettingKey && !m_bIsTextSelected)
		{
			...
			// draw caret
			FGUI::RENDER.Rectangle(arWidgetRegion.m_iLeft + (strTemporaryTextSize.m_iWidth + 1) + 2, arWidgetRegion.m_iTop + (arWidgetRegion.m_iBottom / 2) - (dmTitleTextSize.m_iHeight / 2), 1, dmTitleTextSize.m_iHeight, { 255, 255, 255 });
		}

		// selected text rectangle
		if (m_bIsTextSelected && m_strCustomText.length() > 0)
		{
			FGUI::RENDER.Rectangle(arWidgetRegion.m_iLeft, arWidgetRegion.m_iTop + (arWidgetRegion.m_iBottom / 2) - (dmTitleTextSize.m_iHeight / 2), dmTypedTextSize.m_iWidth, dmTypedTextSize.m_iHeight, { 38, 165, 255, 100 });
		}
	}
